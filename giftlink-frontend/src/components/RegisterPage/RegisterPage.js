...
function RegisterPage() {
    ...
    const handleRegister = async () => {
        ...
        // You can add further actions here, such as form validation or API calls
    };
